...
int main(void) {
    ...
    Tests.run("werks_kvm_add_signed_char", werks_kvm_add_signed_char(my_map, "signed character", 42));
    Tests.run("werks_kvm_add_unsigned_char", werks_kvm_add_unsigned_char(my_map, "unsigned character", 42));
    Tests.run("werks_kvm_add_short", werks_kvm_add_short(my_map, "short integer", 42));
    Tests.run("werks_kvm_add_unsigned_short", werks_kvm_add_unsigned_short(my_map, "unsigned short integer", 42));
    Tests.run("werks_kvm_add_int", werks_kvm_add_int(my_map, "integer", 42));
    Tests.run("werks_kvm_add_unsigned_int", werks_kvm_add_unsigned_int(my_map, "unsigned integer", 42));
    Tests.run("werks_kvm_add_float", werks_kvm_add_float(my_map, "floating point", 42.0f));
    Tests.run("werks_kvm_add_double", werks_kvm_add_double(my_map, "double precision", 42.0));
    Tests.run("werks_kvm_add_long", werks_kvm_add_long(my_map, "long integer", 42));
    Tests.run("werks_kvm_add_unsigned_long", werks_kvm_add_unsigned_long(my_map, "unsigned long integer", 42));
    Tests.run("werks_kvm_add_long_long", werks_kvm_add_long_long(my_map, "long long integer", 42));
    Tests.run("werks_kvm_add_unsigned_long_long", werks_kvm_add_unsigned_long_long(my_map, "unsigned long long integer", 42));
    Tests.run("werks_kvm_add_long_double", werks_kvm_add_long_double(my_map, "long double precision", 42.0L));
    Tests.run("werks_kvm_add_signed_char", werks_kvm_add_signed_char(my_map, "signed character", -42));
    Tests.run("werks_kvm_add_unsigned_char", werks_kvm_add_unsigned_char(my_map, "unsigned character", -42));
    Tests.run("werks_kvm_add_short", werks_kvm_add_short(my_map, "short integer", -42));
    Tests.run("werks_kvm_add_unsigned_short", werks_kvm_add_unsigned_short(my_map, "unsigned short integer", -42));
    ...
    Tests.run("werks_kvm_add_int8", werks_kvm_add_int8(my_map, "int8", 42));
    Tests.run("werks_kvm_add_uint8", werks_kvm_add_uint8(my_map, "uint8", 42));
    Tests.run("werks_kvm_add_int16", werks_kvm_add_int16(my_map, "int16", 42));
    Tests.run("werks_kvm_add_uint16", werks_kvm_add_uint16(my_map, "uint16", 42));
    Tests.run("werks_kvm_add_int32", werks_kvm_add_int32(my_map, "int32", 42));
    Tests.run("werks_kvm_add_uint32", werks_kvm_add_uint32(my_map, "uint32", 42));
    Tests.run("werks_kvm_add_int64", werks_kvm_add_int64(my_map, "int64", 42));
    Tests.run("werks_kvm_add_uint64", werks_kvm_add_uint64(my_map, "uint64", 42));
    Tests.run("werks_kvm_add_int8", werks_kvm_add_int8(my_map, "int8", -42));
    Tests.run("werks_kvm_add_uint8", werks_kvm_add_uint8(my_map, "uint8", -42));
    Tests.run("werks_kvm_add_int16", werks_kvm_add_int16(my_map, "int16", -42));
    Tests.run("werks_kvm_add_uint16", werks_kvm_add_uint16(my_map, "uint16", -42));
    ...
    Tests.run("werks_kvm_get_float", float_equal(*pFloat, TEST_FLOAT, MEH_FLOAT_EPSILON));
    Tests.print("Float: %f\n", *pFloat);
    double* pDouble = werks_kvm_get_double(my_map, "double precision");
    Tests.run("werks_kvm_get_double", double_equal(*pDouble, TEST_DOUBLE, MEH_DOUBLE_EPSILON));
    ...
    Tests.run("werks_kvm_get_long_double", long_double_equal(*pLongDouble, TEST_LONG_DOUBLE, MEH_LONG_DOUBLE_EPSILON));
    ...
    QUICK_KVM(qkvm, {
        ...
        Tests.run("werks_kvm_get_items_count qkvm 3", werks_kvm_get_items_count(qkvm) == 3);
    });
    return Tests.end();
}
