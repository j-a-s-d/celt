...
static inline void test_math_utilities() {
    ...
    Tests.run("float_signbit YES", float_signbit(-0.0));
    Tests.run("float_signbit NO", !float_signbit(0.0));
    Tests.run("double_signbit YES", double_signbit(-0.0));
    Tests.run("double_signbit NO", !double_signbit(0.0));
    Tests.run("long_double_signbit YES", long_double_signbit(-0.0));
    Tests.run("long_double_signbit NO", !long_double_signbit(0.0));
    Tests.run("float_max normal", float_max(0.0f, 1.23f) == 1.23f);
    Tests.run("float_max nan", float_max(0.0f, float_NaN) == 0.0f);
    float tf = float_max(0.0f, -0.0f);
    Tests.run("float_max sign", !float_signbit(tf) && tf == 0.0f);
    Tests.run("double_max normal", double_max(0.0, 1.23) == 1.23);
    Tests.run("double_max nan", double_max(0.0, double_NaN) == 0.0);
    double df = double_max(0.0, -0.0);
    Tests.run("double_max sign", !double_signbit(df) && df == 0.0);
    Tests.run("long_double_max normal", long_double_equal(long_double_max(0.0L, 1.23L), 1.23L, 0.000001L));
    Tests.run("long_double_max nan", long_double_max(0.0L, long_double_NaN) == 0.0L);
    long double lf = long_double_max(0.0L, -0.0L);
    Tests.run("long_double_max sign", !long_double_signbit(lf) && lf == 0.0L);
    Tests.run("float_min normal", float_min(0.0f, -1.23f) == -1.23f);
    Tests.run("float_min nan", float_min(0.0f, float_NaN) == 0.0f);
    tf = float_min(0.0f, -0.0f);
    Tests.run("float_min sign", float_signbit(tf) && tf == -0.0f);
    Tests.run("double_min normal", double_min(0.0, -1.23) == -1.23);
    Tests.run("double_min nan", double_min(0.0, double_NaN) == 0.0);
    df = double_min(0.0, -0.0);
    Tests.run("double_min sign", double_signbit(df) && df == -0.0);
    Tests.run("long_double_min normal", long_double_equal(long_double_min(0.0L, -1.23L), -1.23L, 0.000001L));
    Tests.run("long_double_min nan", long_double_min(0.0L, long_double_NaN) == 0.0L);
    lf = long_double_min(0.0L, -0.0L);
    Tests.run("long_double_min sign", long_double_signbit(lf) && lf == -0.0L);
