...
static inline void test_datetime_utilities() {
    ...
    modify_datetime(&dt, 0, 1, 0, 0, 0, 45);
    Tests.run("modify_datetime leap-year month-roll with day-overflow", dt.year == 2024 && dt.month == 3 && dt.day == 1 && dt.hours == 0 && dt.minutes == 0 && dt.seconds == 15);
    dt = (datetime_dt){ 2024, 2, 28, 23, 59, 30 };
    modify_datetime(&dt, 0, 0, 0, 0, 0, 35);
    Tests.run("modify_datetime leap-year day-roll 1", dt.year == 2024 && dt.month == 2 && dt.day == 29 && dt.hours == 0 && dt.minutes == 0 && dt.seconds == 5);
    dt = (datetime_dt){ 2024, 2, 28, 0, 0, 0 };
    modify_datetime(&dt, 0, 0, 1, 0, 0, 0);
    Tests.run("modify_datetime leap-year day-roll 2", dt.year == 2024 && dt.month == 2 && dt.day == 29 && dt.hours == 0 && dt.minutes == 0 && dt.seconds == 0);
    modify_datetime(&dt, 0, 0, 1, 0, 0, 0);
    Tests.run("modify_datetime leap-year day-roll 3", dt.year == 2024 && dt.month == 3 && dt.day == 1 && dt.hours == 0 && dt.minutes == 0 && dt.seconds == 0);
    dt = (datetime_dt){ 2025, 2, 28, 0, 0, 0 };
    modify_datetime(&dt, 0, 0, 1, 0, 0, 0);
    Tests.run("modify_datetime non-leap-year day-roll", dt.year == 2025 && dt.month == 3 && dt.day == 1 && dt.hours == 0 && dt.minutes == 0 && dt.seconds == 0);
    dt = (datetime_dt){ 2025, 12, 31, 0, 0, 0 };
    modify_datetime(&dt, 0, 0, 1, 0, 0, 0);
    Tests.run("modify_datetime new-year day-roll", dt.year == 2026 && dt.month == 1 && dt.day == 1 && dt.hours == 0 && dt.minutes == 0 && dt.seconds == 0);
    dt = (datetime_dt){ 2025, 12, 31, 23, 59, 59 };
    modify_datetime(&dt, 0, 0, 0, 0, 0, 1);
    Tests.run("modify_datetime new-year second-roll", dt.year == 2026 && dt.month == 1 && dt.day == 1 && dt.hours == 0 && dt.minutes == 0 && dt.seconds == 0);
    modify_datetime(&dt, 0, 0, 0, 0, 0, -1);
    Tests.run("modify_datetime old-year second-roll", dt.year == 2025 && dt.month == 12 && dt.day == 31 && dt.hours == 23 && dt.minutes == 59 && dt.seconds == 59);
    modify_datetime(&dt, 0, 1, 0, 0, 0, 0);
    Tests.run("modify_datetime new-year month-roll 1", dt.year == 2026 && dt.month == 1 && dt.day == 31 && dt.hours == 23 && dt.minutes == 59 && dt.seconds == 59);
    modify_datetime(&dt, 0, 1, 0, 0, 0, 0);
    Tests.run("modify_datetime new-year month-roll 2", dt.year == 2026 && dt.month == 2 && dt.day == 28 && dt.hours == 23 && dt.minutes == 59 && dt.seconds == 59);
    modify_datetime(&dt, 0, -2, 0, 0, 0, 0);
    Tests.run("modify_datetime old-year month-roll 3", dt.year == 2025 && dt.month == 12 && dt.day == 28 && dt.hours == 23 && dt.minutes == 59 && dt.seconds == 59);
